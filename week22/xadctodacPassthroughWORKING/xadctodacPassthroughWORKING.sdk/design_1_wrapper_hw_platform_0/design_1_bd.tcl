...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.POLARITY {ACTIVE_HIGH}  ] $reset_0
  ...
  set_property -dict [ list CONFIG.CLKOUT2_JITTER {130.958} CONFIG.CLKOUT2_PHASE_ERROR {98.575} CONFIG.CLKOUT2_USED {true} CONFIG.CLK_IN1_BOARD_INTERFACE {sys_clock} CONFIG.MMCM_CLKOUT1_DIVIDE {10} CONFIG.MMCM_DIVCLK_DIVIDE {1} CONFIG.NUM_OUT_CLKS {2} CONFIG.USE_BOARD_FLOW {true}  ] $clk_wiz_0

  # Create instance: filter_31_16_0, and set properties
  set filter_31_16_0 [ create_bd_cell -type ip -vlnv user.org:user:filter_31_16:5.0 filter_31_16_0 ]
  ...
  set_property -dict [ list CONFIG.C_DEBUG_ENABLED {1} CONFIG.C_D_AXI {1} CONFIG.C_D_LMB {1} CONFIG.C_I_LMB {1} CONFIG.C_USE_FPU {2}  ] $microblaze_0
  ...
  set_property -dict [ list CONFIG.CONST_VAL {1} CONFIG.CONST_WIDTH {1}  ] $xlconstant_1
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins clk_wiz_0/clk_out2]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rst_clk_wiz_0_100M/dcm_locked]
  connect_bd_net -net filter_27_downto_12_0_data_out [get_bd_pins filter_31_16_0/data_out] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_0_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins DAC_0/clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins filter_31_16_0/clk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk] [get_bd_pins xadc_block_0/clk]
  ...
  connect_bd_net -net xadc_block_0_out_data [get_bd_pins filter_31_16_0/data_in] [get_bd_pins xadc_block_0/out_data]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins DAC_0/sw] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins blk_mem_gen_0/dinb] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins blk_mem_gen_0/enb] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins blk_mem_gen_0/rstb] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net xlconstant_3_dout [get_bd_pins blk_mem_gen_0/web] [get_bd_pins xlconstant_3/dout]
  connect_bd_net -net xlconstant_4_dout [get_bd_pins blk_mem_gen_0/addrb] [get_bd_pins xlconstant_4/dout]
  ...
  connect_bd_net -net xlslice_2_Dout [get_bd_pins blk_mem_gen_0/doutb] [get_bd_pins filter_31_16_0/sw]
