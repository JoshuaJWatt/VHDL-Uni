...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.FREQ_HZ {100000000}  ] $diff_clock_rtl
  ...
  set_property -dict [ list CONFIG.PRIM_SOURCE {Differential_clock_capable_pin} CONFIG.RESET_BOARD_INTERFACE {reset} CONFIG.USE_BOARD_FLOW {true}  ] $clk_wiz_1
