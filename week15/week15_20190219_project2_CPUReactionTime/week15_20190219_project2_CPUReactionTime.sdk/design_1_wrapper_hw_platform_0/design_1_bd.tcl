...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set JA [ create_bd_port -dir I -from 0 -to 0 JA ]
  set JB [ create_bd_port -dir O -from 0 -to 0 JB ]
  ...
  set_property -dict [ list CONFIG.CONST_WIDTH {32}  ] $xlconstant_0
  ...
  set_property -dict [ list CONFIG.DIN_FROM {15} CONFIG.DOUT_WIDTH {16}  ] $xlslice_0

  # Create instance: xlslice_1, and set properties
  set xlslice_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_1 ]
  set_property -dict [ list CONFIG.DIN_FROM {0} CONFIG.DIN_TO {0} CONFIG.DOUT_WIDTH {1}  ] $xlslice_1
  ...
  # Create port connections
  connect_bd_net -net In0_1 [get_bd_ports btnL] [get_bd_pins microblaze_0_xlconcat/In0]
  connect_bd_net -net In1_1 [get_bd_ports JA] [get_bd_pins microblaze_0_xlconcat/In1]
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins blk_mem_gen_0/doutb] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_clk_wiz_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_0_100M/peripheral_aresetn]
  ...
  connect_bd_net -net xlslice_1_Dout [get_bd_ports JB] [get_bd_pins xlslice_1/Dout]
